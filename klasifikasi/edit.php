...
$menu = "../menu.php";
$profil = "../profil.php";
$title = "EDIT || klasifikasi || SIWADES";
 ?>
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        ...
                        <div class="block">
                            ...
                            <form action="edit.php?id<?php echo $edit['id_klasifikasi']; ?>" method="post" class="form-horizontal form-bordered">
                                <div class="form-group">
                                    <input type="hidden" name="id_klasifikasi" value="<?php echo $edit['id_klasifikasi']; ?>">
                                    <label class="col-md-3">Nama Klasifikasi</label>
                                    <div class="col-md-8">
                                        <input type="text" name="nama_klasifikasi" class="form-control" placeholder="Nama Klasifikasi" value="<?php echo $edit['nama_klasifikasi'] ?>">
                                    </div>
                                </div>
