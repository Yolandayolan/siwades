                                    ...
                                    <?php $no=0; foreach ($klas as $row): $no++?>
                                        <tr>
                                            ...
                                            <?php 
                                                ...
                                                $jum = $_mysqli->query("SELECT penduduk.nama FROM penduduk, klasifikasi 
                                            ...
                                            <td class="text-center">
                                                <a href="detail.php?detail=<?php echo $row['id_klasifikasi']; ?>" data-toggle="tooltip" title="Detail <?php echo $row['nama_klasifikasi']?>" class="btn btn-effect-ripple btn-warning"><i class="fa fa-search"></i></a>
                                                <a href="edit.php?edit=<?php echo $row['id_klasifikasi']; ?>" data-toggle="tooltip" title="Edit <?php echo $row['nama_klasifikasi']?>" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                                <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row['nama_klasifikasi'] ?> ?');" href="?hapus=<?php echo $row['id_klasifikasi']; ?>" data-toggle="tooltip" title="Delete <?php echo $row['nama_klasifikasi']?>" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
